...
<body style="background-color: rgb(245, 245, 245); font-family: 'Open Sans', sans-serif; color: #A6A6A6; padding: 30px 40px;">
   ...
   <h1 style="width: 100%; font-family: 'Lobster', cursive; font-size: 30px; color: #153350; margin: 0; margin-bottom: 40px; font-weight: normal;">Vous avez reçu un message !</h1>
   ...
   <h2 style="width: 100%; font-family: 'Lobster', cursive; font-size: 20px; color: #2B657C; margin: 0; margin-bottom: 20px; margin-top: 70px; font-weight: normal; text-align: end;">N'hésitez pas à lui répondre !</h2>
